...
function clubAliasKeys(value) {
  ...
  const explicitAliases = {
    ...
    "athletic-bilbao": ["athl", "athletic", "athletic-club"],
    "atletico-de-madrid": ["atleti", "atletico"],
    "baltika-kaliningrad": ["balt", "baltika"],
    "bayer-04-leverkusen": ["leverkusen"],
    "bologna-fc-1909": ["bolo", "bologna"],
    "borussia-dortmund": ["dortmund"],
    "borussia-monchengladbach": ["monchengladbach"],
    "brighton-hove-albion": ["brighton", "brighton-hove"],
    "brentford-fc": ["brentford"],
    "cagliari-calcio": ["caglia", "cagliari"],
    "celta-de-vigo": ["celta"],
    "como-1907": ["como"],
    "deportivo-alaves": ["alaves"],
    "dinamo-makhachkala": ["dinamo-makhach", "dinamo-makhachk", "dinamo-makhachkala"],
    "dynamo-moscow": ["din-m", "dynamo"],
    "eintracht-frankfurt": ["frankfurt"],
    "everton-fc": ["everton"],
    "fc-augsburg": ["augsburg"],
    "fc-barcelona": ["barcelona", "barca"],
    "fc-krasnodar": ["krasnodar", "krsndr"],
    "fc-lorient": ["fcl", "lorient"],
    "fc-metz": ["metz"],
    "fc-nantes": ["fcn", "nantes"],
    "fc-orenburg": ["orenburg"],
    "fc-rostov": ["rostov"],
    "fc-pari-nizhniy-novgorod": ["pari", "pari-nn"],
    "fc-sochi": ["fk-sochi", "sochi"],
    "fc-st-pauli": ["st-pauli"],
    "fc-toulouse": ["tfc", "toulouse"],
    "genoa-cfc": ["genoa"],
    "hamburger-sv": ["hamburg"],
    "hellas-verona": ["hellas"],
    "inter-milan": ["inter"],
    "juventus-fc": ["juve", "juventus"],
    "krylya-sovetov-samara": ["ks-samara", "samara"],
    "le-havre-ac": ["hac", "le-havre"],
    "leeds-united": ["leeds"],
    "lokomotiv-moscow": ["loko", "loko-moscow", "lokomotiv"],
    ...
    "rayo-vallecano": ["rayo"],
    "rc-lens": ["lens", "rcl"],
    "rc-strasbourg-alsace": ["r-strasbourg", "rcsa", "strasbourg"],
    "rcd-espanyol-barcelona": ["espany", "espanyol"],
    ...
    "sevilla-fc": ["sevill", "sevilla"],
    "ssc-napoli": ["napoli"],
    "ss-lazio": ["lazio"],
    "stade-brestois-29": ["sb29", "stade-brestois", "brest"],
    "stade-rennais-fc": ["srfc", "stade-rennais", "rennes"],
    "sunderland-afc": ["sunderland"],
    "sv-werder-bremen": ["werder", "werder-bremen"],
    "angers-sco": ["angers"],
    "levante-ud": ["levante"],
    "torino-fc": ["torino"],
    "tottenham-hotspur": ["tottenham"],
    "tsg-1899-hoffenheim": ["hoffenheim"],
    "udinese-calcio": ["udine", "udinese"],
    "us-cremonese": ["cremonese"],
    "us-lecce": ["lecce"],
    "us-sassuolo": ["sassuo", "sassuolo"],
    ...
    "zenit-st-petersburg": ["zenit", "zenit-s-pb"],
  };
